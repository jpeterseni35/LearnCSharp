...
namespace BirthDayCalculator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Announce information about users date of birth
        ...
        public static DateTimeOffset AskForDateOfBirth()
        {
            ...
            // Until the checked date of birth is greater than today...
            while (dateOfBirth > DateTimeOffset.UtcNow)
            {
                // Tell the user to enter their date of birth
                System.Console.WriteLine($"Can I start by asking you " +
        ...
        public static void AnnounceDateOfBirthInformation(DateTimeOffset date)
        {
            ...
            // Display their date of birth.
            System.Console.WriteLine($"So you were born on {date:d MMMM yyyy}.");

            // Display day of the week they were born.
            System.Console.WriteLine($"That was a {date.DayOfWeek}.");

            //Indicate if we have already passed the users date of birth for the current year.
            ...
            System.Console.WriteLine($"It is {(nextBirthday - now).TotalDays:0} days until your next birthday.");

            // Get the users age.
            var userAge = now.Year - date.Year - (hasPassedBirthday ? 0 : 1);

            // Display users age.
            System.Console.WriteLine($"You are {userAge} years old.");

            // Display users age in dog years.
            System.Console.WriteLine($"You are {userAge * 7} years old in dog years.");

            // Get users time alive.
            var timeAlive = now - date;

            // Display days old.
            System.Console.WriteLine($"You are {timeAlive.TotalDays:n0} days old");

            // Display hours old.
            System.Console.WriteLine($"You are {timeAlive.TotalHours:n0} hours old");

            // Display seconds old.
            System.Console.WriteLine($"You are {timeAlive.TotalSeconds:n0} seconds old");
        }
    }
